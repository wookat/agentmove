...
thirty-two clients — OpenClaw, Hermes Agent, Claude Code, Codex CLI, Cursor,
...
| Layer | Notes |
| --- | --- |
| MCP servers | Near-lossless between all thirty-two clients (JSON/JSON5/TOML/YAML shapes normalized) |
