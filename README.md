...
twenty-five clients — OpenClaw, Hermes Agent, Claude Code, Codex CLI, Cursor,
...
| Layer | Notes |
| --- | --- |
| MCP servers | Near-lossless between all twenty-five clients (JSON/JSON5/TOML/YAML shapes normalized) |
