...
twenty-eight clients — OpenClaw, Hermes Agent, Claude Code, Codex CLI, Cursor,
...
| Layer | Notes |
| --- | --- |
| MCP servers | Near-lossless between all twenty-eight clients (JSON/JSON5/TOML/YAML shapes normalized) |
