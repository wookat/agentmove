...
| Continue | `continue` | `~/.continue/config.yaml` (`mcpServers` list + inline `prompts:`/`rules:`), `~/.continue/mcpServers/` (yaml + json MCP block files), `~/.continue/rules/` (markdown + yaml block files), `~/.continue/skills/`, `~/.continue/prompts/` (markdown + yaml block files) |
