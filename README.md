...
| OpenCode | `opencode` | `~/.config/opencode/opencode.json` (`mcp`), `~/.config/opencode/AGENTS.md`, skills from `~/.config/opencode/{skills,skill}/` + the `~/.opencode/{skills,skill}/` fallback + shared `~/.agents/skills/` (first root wins duplicates; imports write `~/.config/opencode/skills/`), `~/.config/opencode/agents/` (custom agents), `~/.config/opencode/commands/` (custom commands) |
